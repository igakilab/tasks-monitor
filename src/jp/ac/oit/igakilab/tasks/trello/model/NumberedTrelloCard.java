...
public class NumberedTrelloCard extends TrelloCard{
	public static String TASKNUMBER_REGEX = "#([0-9]+)\\s*";

	public static void main(String[] args){
		NumberedTrelloCard card = new NumberedTrelloCard();
	...
	public NumberedTrelloCard(){
		super();
	}

	public NumberedTrelloCard(TrelloCard card){
		super();
		this.id = card.id;
